import { SERVICE_LIST, QUALITY_LIST } from '../lib/constants';
import { ShieldCheck, Check } from 'lucide-react';

export const ServicesSection = () => {
  return (
    <section id="Dịch vụ" className="py-16 bg-white">
      <div className="container mx-auto px-6">
        <div className="mb-12 text-center">
          <h2 className="text-2xl md:text-3xl font-bold uppercase tracking-widest text-zinc-900">Dịch vụ của chúng tôi</h2>
