...
export default function EditMenuPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const menu = useQuery(api.menus.getById, { id: id as Id<'menus'> });
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-slate-900 dark:text-white">Chỉnh sửa menu</h1>
                ...
                <div className="flex flex-wrap items-center gap-2 mt-2">
                  ...
                  <select
                    onChange={(e) => {
                      ...
                      if (post) {
                        setFormData({ ...formData, url: `/bai-viet/${post.slug}` });
                      }
                      e.target.value = '';
                    }}
